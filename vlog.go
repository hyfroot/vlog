...
// Fatal is equivalent to l.Print() followed by a call to sys.Exit(1).
func (l *Logger) Fatal(v ...interface{}) {
	l.Output(2, Lerror, fmt.Sprint(v...))
	os.Exit(1)
}

// Fatalf is equivalent to l.Printf() followed by a call to sys.Exit(1).
func (l *Logger) Fatalf(format string, v ...interface{}) {
	l.Output(2, Lerror, fmt.Sprintf(format, v...))
	os.Exit(1)
}

// Fatalln is equivalent to l.Println() followed by a call to sys.Exit(1).
...
// Fatal is equivalent to Print() followed by a call to sys.Exit(1).
func Fatal(v ...interface{}) {
	std.Output(2, Lerror, fmt.Sprint(v...))
	os.Exit(1)
}

// Fatalf is equivalent to Printf() followed by a call to sys.Exit(1).
func Fatalf(format string, v ...interface{}) {
	std.Output(2, Lerror, fmt.Sprintf(format, v...))
	os.Exit(1)
}

// Fatalln is equivalent to Println() followed by a call to sys.Exit(1).
